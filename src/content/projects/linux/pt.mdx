...
<details>
    ...
    Esse projeto está em constante evolução. Confira o repositório para mais detalhes. <a href="https://github.com/andre-brandao/nixos">GitHub</a>
</details>
...
Eu criei minha própria shell utilizando [AGS](https://github.com/Aylur/ags). Ela utiliza o mesmo repositório de cores do Stylix e permite customizações rápidas e simples de cores e estilos.
...
Além disso, utilizo o Pyprland para a criação de scratchpads que me permitem ter janelas flutuantes com comandos rápidos, e o Pyprland para a criação de workspaces dinâmicos.

Muito útil para acessar o terminal, WhatsApp, Spotify e outros aplicativos rapidamente com apenas um botão.

![Scratchpad](./scratchpads.gif)

## Nix Config

Para mais detalhes, acesse o [repositório](https://github.com/andre-brandao/nixos).
