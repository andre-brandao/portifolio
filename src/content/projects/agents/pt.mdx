---
title: 'Dev Agents'
description: 'Planos aprovados por humanos, executados por agentes de IA e acompanhados por eventos do repositório'
date: 2026-07-01
cover: "./overview.png"
tags:
  - TypeScript
...
O Dev Agents é uma plataforma para rodar trabalho de desenvolvimento feito por IA dentro de bases de código existentes, sem perder de vista o que os agentes estão fazendo. O fluxo tem três passos: uma pessoa revisa e aprova um plano, os agentes o implementam, e tudo o que eles fazem é acompanhado por eventos do repositório, verificações de saúde e revisões de código.
