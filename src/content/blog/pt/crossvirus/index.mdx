...
## Introdução
CrossVirus foi um projeto iniciado durante a epoca da pandemia de COVID-19 pelo meu professor Sandro Laudares. O projeto foi desenvolvido para mapear e controlar o avanço do COVID-19 em Belo Horizonte, Minas Gerais. O projeto foi desenvolvido em colaboração com a prefeitura de João Monlevade.
